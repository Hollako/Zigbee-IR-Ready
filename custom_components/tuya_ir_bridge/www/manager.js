...
class ZigbeeIRPanel extends HTMLElement {
  ...
  render() {
    ...
    this.shadowRoot.innerHTML=`<style>${CSS}
      ...
      .main {padding:24px;overflow:auto} form{max-width:1400px} .field-row{flex-wrap:wrap}
      ...
      @media(max-width:600px){.field-label,.choice-title{width:100%}.choice-group{display:block}.choice-box{margin-top:6px}.main{padding:12px}}
      </style>
