...
(async()=>{
  ...
  try {
    ...
    await page.route('http://panel.test/**',async route=>{
      ...
      window.hass={themes:{darkMode:true},states:{'sensor.living_room_temperature':{entity_id:'sensor.living_room_temperature',attributes:{friendly_name:'Living Room Temperature'}},'sensor.living_room_humidity':{entity_id:'sensor.living_room_humidity',attributes:{friendly_name:'Living Room Humidity'}},'binary_sensor.ac_power':{entity_id:'binary_sensor.ac_power',attributes:{friendly_name:'AC Power'}}},callWS:async message=>{
